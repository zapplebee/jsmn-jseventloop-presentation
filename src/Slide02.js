...
export default (props) => (
  <Section className='is-warning is-bold'>
    <h1 className='title is-1'>Overview | The Event Loop?</h1>
    <div className='content'>
      <ol>
        <li style={{marginBottom: '1.5rem'}}><h1 className='title is-3'>The Stack</h1><p>Explore the underlying workings for what makes JS work</p></li>
        <li style={{marginBottom: '1.5rem'}}><h1 className='title is-3'>Web APIs and the Callback Queue</h1><p>How do Web APIs interact with the main thread</p></li>
